...
const float GRAVITY = 0.2;       // Reduced gravity for slower falling
const float JUMP_STRENGTH = -4.0; // Adjusted jump strength

// Obstacle constants
const int OBSTACLE_WIDTH = 10;
int obstacleX;
int gapY;
const int GAP_HEIGHT = 30;       // Increased gap height for easier navigation
const int OBSTACLE_SPEED = 1;    // Slower obstacle speed
...
void resetGame() {
  ...
  obstacleX = 128;
  // Randomize the gap position (with a margin at top and bottom)
